	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="form-group">
				...
				{!! Form::textarea('minimumRequirement', null, [ 'class' => 'form-control', 'required']) !!}
			</div>
			<div class="form-group">
				{!! Form::label('recommendRequirement', 'Recommend Requirement', [ 'class' => 'control-label' ]) !!}
				{!! Form::textarea('recommendRequirement', null, [ 'class' => 'form-control', 'required']) !!}
			</div>
			<div class="form-group">
			...
			<!-- <div class="form-group">
				...
				{!! Form::date('releaseTime', null, [ 'class' => 'form-control']) !!}
			</div> -->
			<div class="form-group">
				{!! Form::label('downloadLink', 'Link download', [ 'class' => 'control-label' ]) !!}
				{!! Form::text('downloadLink', null, [ 'class' => 'form-control']) !!}
			</div>
			<div class="form-group">
